...
function MapComponent({userLocation}) {
  ...
  const LocateControl = () => {
    ...
    return <div>
          <img 
      src='../../../../assets/images/profilephoto/worker.png' // Path to your image
      alt="Locate Me" 
 ...
 console.log("userLocation",userLocation);
  return (
    ...
    <MapContainer center={positions[0]} zoom={userLocation ? 15 : 13} style={{ height: '30vh', width: '100%',zIndex:1 }}>
      <TileLayer
      ...
      {positions.map((position, index) => (
        ...
        <Marker key={index} position={position} >
          <Popup>
            ...
            <CircularMarker>
              <img src={require('../../../../assets/images/profilephoto/302321278.jpg')} alt={`Point ${index + 1}`} />
            </CircularMarker>
            <div>جواد مقبلی</div>
            </div>
          </Popup>
      ...
      {userLocation && (
        <Marker position={userLocation} icon={blueDotIcon}>
          <Popup>
            <CircularMarker>
              <img src={require('../../../../assets/images/profilephoto/302321278.jpg')} />
            </CircularMarker>
          </Popup>            
          </Marker>
